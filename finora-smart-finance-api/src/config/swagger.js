...
const options = {
  definition: {
        ...
        Transaction: {
          ...
          properties: {
            ...
            category: {
              type: 'string',
              enum: [
                'Lebensmittel', 'Transport', 'Unterhaltung', 'Miete', 'Versicherung',
                'Gesundheit', 'Bildung', 'Kleidung', 'Reisen', 'Elektronik',
                'Restaurant', 'Sport', 'Haushalt', 'Sonstiges',
                'Gehalt', 'Freelance', 'Investitionen', 'Geschenk',
                'Bonus', 'Nebenjob', 'Cashback', 'Vermietung',
              ],
            },
    ...
    tags: [
      ...
      { name: 'Transactions', description: 'Transaktionen erstellen, lesen, aktualisieren, löschen' },
