...
function getStatusBackgroundColor(status) {
  switch (status) {
    ...
    case 'info':
      return EMAIL_COLORS.infoLight;
    default:
      return EMAIL_COLORS.surface;
  }
}
...
function getStatusTextColor(status) {
  switch (status) {
    case 'success':
      return EMAIL_COLORS.successText;
    case 'warning':
      return EMAIL_COLORS.warningText;
    case 'error':
      return EMAIL_COLORS.errorText;
    case 'info':
      return EMAIL_COLORS.infoText;
    default:
