 ...
 * @param {*} data - Request body (unused in production)
 */
function logRequest(method, url, data) {
  // Completely silent - use browser DevTools Network tab instead
 ...
 * @param {*} data - Response body (unused in production)
 */
function logResponse(method, url, status, data) {
  // Completely silent - use browser DevTools Network tab instead
  void [method, url, status, data]; // Suppress unused parameter warning
}
