/**
 * @fileoverview MiniFooter — Reduzierte Navigationsleiste für Standalone-Seiten
 * @description Zeigt essentielle Links (Startseite, Impressum, Datenschutz, AGB).
 * Kein Newsletter, kein Brand — nur Navigation.
 */
...
export default function MiniFooter() {
  ...
  return (
    <nav className={styles.miniFooter} aria-label={t('miniFooter.ariaLabel')}>
      <Link to="/" className={styles.link}>{t('miniFooter.home')}</Link>
