      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <div className={styles.quickOptions} role="radiogroup" aria-label={t('dashboard.filter.selectPeriod', 'Zeitraum wählen')}>
